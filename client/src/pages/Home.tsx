          ...
          <nav className="flex flex-col items-center gap-1">
            {[
              ...
              <a
                key={item.label}
                href={item.href}
                className="menu-item font-['Playfair_Display'] text-4xl md:text-6xl font-bold text-[#F5E6C8]/30 hover:text-[#C9A96E] transition-all duration-500 py-3 tracking-wider"
