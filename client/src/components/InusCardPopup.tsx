 ...
 * 스타일: Art Deco / Midnight Jazz Lounge 테마
 */
import { useEffect, useState } from "react";
import { X, ChevronDown, ChevronUp, Gift } from "lucide-react";

const POPUP_IMG = "/manus-storage/popup-inuscard_b05657c7.png";
...
export default function InusCardPopup() {
  ...
  return (
    ...
    >
      ...
      {/* 펼쳐진 내용 */}
      <div
        className={`overflow-hidden transition-all duration-[400ms] ease-out origin-top-left ${
        ...
        >
          ...
          >
            <div className="mt-0.5 flex-shrink-0">
              <Gift size={18} style={{ color: "#C9A96E" }} />
            </div>
            <div>
              <p
              ...
              >
                ...
                {" "}
                모바일 청첩장{" "}
                <span style={{ color: "#7ECEC1" }} className="font-semibold">
                  무료 제작 지원
                </span>
              </p>
            </div>
